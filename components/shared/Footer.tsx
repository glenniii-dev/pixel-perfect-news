...
export default function Footer() {
  return (
    <footer className="bg-linear-90 from-(--rich-black) to-(--chambray) text-(--stardust-white) text-lg flex flex-col max-lg:space-y-12 lg:flex-row flew-wrap justify-between p-4 px-8 py-12">
      <div>
        <p className="font-extrabold text-2xl text-(--silver-lake-blue) max-md:text-(--silver-lake-blue) mb-3 lg:mb-6">Pixel Perfect News</p>
      ...
      <div>
        ...
        <nav className="text-(--stardust-white) flex flex-wrap flex-col space-y-2">
          <Link href="mailto:pixelperfectnews@email.com" className="hover:underline hover:underline-offset-4 hover:decoration-(--silver-lake-blue) hover:decoration-2">pixelperfectnews@email.com</Link>
          <Link href="/" className="hover:underline hover:underline-offset-4 hover:decoration-(--silver-lake-blue) hover:decoration-2">@pixelperfectnews</Link>
        </nav>
      </div>
